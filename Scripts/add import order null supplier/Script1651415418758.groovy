...
WebUI.click(findTestObject('Object Repository/div_dell 22'))

WebUI.setText(findTestObject('Object Repository/input_dell 22_ant-input-number-input'), '11')

WebUI.click(findTestObject('Object Repository/button_Thm'))

WebUI.click(findTestObject('Object Repository/button_Submit'))

WebUI.verifyElementPresent(findTestObject('Object Repository/div_Trng bt buc'), 10)
