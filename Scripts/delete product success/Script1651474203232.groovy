...
WebUI.click(findTestObject('Object Repository/Page_React App/span_OK'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_React App/span_Thc hin xa sn phm thnh cng'), 0)
