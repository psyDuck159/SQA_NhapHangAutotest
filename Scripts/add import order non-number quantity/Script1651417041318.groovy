...
WebUI.setText(findTestObject('Object Repository/input_Dell Inspiron 1_ant-input-number-input'), 'abc')
...
WebUI.verifyElementPresent(findTestObject('div_SoluongMatHangLonHon0'), 10)
