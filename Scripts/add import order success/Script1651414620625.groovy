...
WebUI.click(findTestObject('Object Repository/div_Tn sn phm'))

WebUI.click(findTestObject('Object Repository/div_Dell Inspiron 1'))

WebUI.setText(findTestObject('Object Repository/input_Dell Inspiron 1_ant-input-number-input'), '11')

WebUI.click(findTestObject('Object Repository/button_Thm'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/div_To mi n hng thnh cng'), 10)
