...
WebUI.setText(findTestObject('Object Repository/input_Username_basic_username'), 'arnold')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/h2_Qun l sn phm'), 0)
