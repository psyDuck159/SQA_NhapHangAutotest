...
WebUI.click(findTestObject('Object Repository/Page_React App/form_UsernamePasswordSubmit'))
...
WebUI.click(findTestObject('Object Repository/Page_React App/span_Cancel'))
